...
{{ csrf_field() }}
    ...
    <input type="text" hidden value="<?php echo $blogs[0]->blog_id;?>" name="id" >
    <input type="text" class="form-control" name="header" id="field1" placeholder="Insert header" value="<?php echo $blogs[0]->header;?>" >
  </div>
 ...
 <option selected><?php echo $blogs[0]->category?></option>
